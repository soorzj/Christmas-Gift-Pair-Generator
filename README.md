...
- **Roll Number support** – Roll numbers generated instead of names in one click.
- **Interactive Cards** – Click a card to mark gifts as exchanged with animated feedback.

- **Odd Number Support** – Warns and handles uneven participant lists gracefully.  
- **Festive Animations** – Snowfall, card pop-in effects, and smooth transitions.  
